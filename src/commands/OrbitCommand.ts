...
export class OrbitCommand extends BaseCommand {
    ...
    async response () : Promise<CommandResponse> {
        ...
        const response = await Request(`https://api.spacetraders.io/v2/my/ships/${this.system.ship.get.symbol}/orbit`, options);
